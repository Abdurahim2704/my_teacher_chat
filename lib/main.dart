...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> testApp() async {
    ...
    final createConversation = await service.createConversation(
        "6d834b47-d9d5-4c05-a6bb-8ab6e8e3e0bd",
        "4b40308d-4e6e-4422-8630-41a916dda603",
        "Jaloliddin aka chatni o'chirvoring");
    if (createConversation is DataSuccess) {
      final data = createConversation.data;
      print(data);
    } else {
      print("It is failed");
      print(createConversation.message);
    }
  }
